# CIC Personal Lines: Homeowners Policy Deep Dive
...
This is the CIC perspective — practical, form-driven, and focused on what agents need to know to serve clients. Where CPCU teaches you the theory of homeowners insurance, CIC teaches you how to read the form, spot the gaps, and protect your client (and yourself from E&O).

---

## The HO-3 Special Form: Section I (Property)
...
**What it covers:**
- Hotel, temporary rental, restaurant meals (the *increase* over normal expenses)
...
13. Sudden cracking/bulging of heating or cooling system
14. Freezing of plumbing, heating, AC
15. Sudden damage from artificially generated electrical current
16. Volcanic eruption

**What's NOT on the list**: Flood, earthquake, gradual water damage, mold, vermin, wear and tear.

---

## Key HO-3 Exclusions with Real-World Examples

| Exclusion | Real-World Scenario |
|-----------|-------------------|
| **Earth movement** | Foundation cracks from settling. Not covered — need earthquake endorsement for seismic events |
| **Water damage** (flood) | River overflows into basement. Not covered — need NFIP or private flood |
| **Power failure** (off premises) | Grid goes down, pipes freeze. Excluded if the power failure originates off premises |
| **Neglect** | Roof damaged by wind; insured doesn't tarp it; water damage spreads. Additional damage from neglect is excluded |
| **Intentional loss** | Insured sets fire. No coverage |
| **Ordinance or law** | City requires upgraded electrical when rebuilding after a fire. Cost to comply is excluded without the O&L endorsement |
| **Business pursuits** | Client runs daycare from home, child is injured. Liability excluded — need business endorsement |

---

## Additional Coverages You Need to Know
...
## Endorsements Agents Use Most

| Endorsement | Why Every Agent Should Know It |
|-------------|-------------------------------|
| **Water backup/sump overflow** | #1 gap. Base policy excludes sewer/drain backup. Cheap to add, expensive to miss |
| **Ordinance or law** | Pays to bring the home up to code after a loss. Essential for pre-1990 homes |
| **Service line coverage** | Covers buried utility lines (water, sewer, electrical) from the home to the street |
| **Equipment breakdown** | Covers HVAC, electrical panels, appliances from mechanical/electrical failure |
| **Home business** | Extends property and liability for home-based business operations |
| **Scheduled personal property** | Eliminates sub-limits on high-value items |
| **Identity fraud** | Covers expenses from identity theft |
| **Replacement cost on contents** | Changes personal property from ACV to replacement cost |
| **Inflation guard** | Automatically increases Coverage A each quarter |
...
6. **Do you have a pool, trampoline, or dog?** (Liability adequacy, umbrella)
7. **Have you checked your liability limits recently?** (Umbrella recommendation)

---

## Practice Questions

**1.** A client's HO-3 has $400K on Coverage A. Their $8,000 engagement ring is stolen. How much does the policy pay for the ring?
...
<details>
<summary>Answer</summary>
Yes. "Accidental discharge or overflow of water or steam" from within a plumbing system is a covered peril. The key word is "sudden" — gradual leaking over months would NOT be covered. The damage to the wall, floor, and contents from the burst pipe is covered.
</details>

**3.** A client's sewer line backs up into the basement, causing $20,000 in damage. They have a standard HO-3 with no endorsements. What's covered?
...
<details>
<summary>Answer</summary>
No, not without the Ordinance or Law endorsement. The base policy only pays to rebuild what was there before — it excludes increased costs due to enforcement of building codes. This endorsement is critical for older homes.
</details>

**5.** Personal property under the HO-3 is covered on what basis — open peril or named peril?
